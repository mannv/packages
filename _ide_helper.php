...
namespace Manvn\BootstrapForm\Facades { 
    ...
    class BTFormFacade {
         ...
         *
         * @param \Illuminate\Contracts\Session\Session $session
         * @return \Manvn\BootstrapForm\Builder\BTFormBuilder 
         * @static 
         */ 
        ...
        {
            //Method inherited from \Collective\Html\FormBuilder            
                        \Manvn\BootstrapForm\Builder\BTFormBuilder::macro($name, $macro);
        }
        ...
        {
            //Method inherited from \Collective\Html\FormBuilder            
                        \Manvn\BootstrapForm\Builder\BTFormBuilder::mixin($mixin, $replace);
        }
        ...
        {
            //Method inherited from \Collective\Html\FormBuilder            
                        return \Manvn\BootstrapForm\Builder\BTFormBuilder::hasMacro($name);
        }
        ...
        {
            //Method inherited from \Collective\Html\FormBuilder            
                        \Manvn\BootstrapForm\Builder\BTFormBuilder::component($name, $view, $signature);
        }
        ...
        {
            //Method inherited from \Collective\Html\FormBuilder            
                        return \Manvn\BootstrapForm\Builder\BTFormBuilder::hasComponent($name);
        }
    ...
    class BTMandatoryFacade {
         ...
         * @static 
         */ 
        public static function mandatory($abstractRequest)
        {
                        /** @var \Manvn\BootstrapForm\Builder\BTMandatoryBuilder $instance */
                        return $instance->mandatory($abstractRequest);
        }
...
namespace  { 
    ...
    class BTForm extends \Manvn\BootstrapForm\Facades\BTFormFacade {}

    class BTMandatory extends \Manvn\BootstrapForm\Facades\BTMandatoryFacade {}
